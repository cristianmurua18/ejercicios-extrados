...
namespace APIDAO.Controllers
{
    ...
    {
        //Uso el DAO en el controlador, no es bueno. Debo usar el servicio. OKA
        //private readonly DAOUser _myDao;
        ...
        public IActionResult ObtenerUsuarioPorEmail(string email)
        {
            ...
            else Console.WriteLine($"Id: {result.Id},Nombre: {result.LastName}, Email:{result.EmailAddress}, Edad:{result.Age}");
            //ver de implementar operador ternario. OKA
            return Ok(result);
        }
